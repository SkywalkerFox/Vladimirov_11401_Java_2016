...
public class ComplexMatrix2x2Test {
    ...
    public void matrixCreation() {
        defaultMatrix = new ComplexMatrix2x2();
        matrix1 = new ComplexMatrix2x2(new ComplexNumber(1, 1));
        matrix4 = new ComplexMatrix2x2(new ComplexNumber(1, 1), new ComplexNumber(2, 2), new ComplexNumber(3, 3), new ComplexNumber(4, 4));
    }
