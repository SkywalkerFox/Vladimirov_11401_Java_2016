    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 text-center v-center">
                ...
                <form action="/supply/send" method="post" class="col-lg-12">
                    <div class="input-group" style="width: 700px; text-align: center; margin: 0 auto;">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input id="size" name="size" class="form-control" required>
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="mass">Масса груза(кг):</label>
                            <input id="mass" name="mass" class="form-control" required>
                        </div>
                        <br><br><br><br><br>
                        <div class="form-group">
                            <label for="reciever">Кому:</label>
                            <select id="reciever" name="reciever" class="form-control" required>
                                <option selected="selected">Выберите получателя</option>
                            <#if users??>
                                <#list users as u>
                                    <option>${u.getFirstName() + " " + u.getLastName() + "(" + u.getEmail() + ")"}</option>
                                </#list>
                            </#if>
                            </select>
                    ...
                    <#--<#if date??>-->
                    <#--<div>-->
                    <#--<label for="date">Дата и время запроса:</label>-->
                    <#--<input id="date" name="date" class="form-control" value="${date}" disabled>-->
                    <#--</div>-->
                    <#--</#if>-->
