    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li class="selected"><a href="/profile"><i class="fa fa-tasks"></i> Профиль</a></li>
                <li><a href="/supply"><i class="fa fa-globe"></i> Blog</a></li>
                <li><a href="/signin"><i class="fa fa-list-ol"></i> SignUp</a></li>
            ...
            <ul class="nav navbar-nav navbar-right navbar-user">
                <li class="dropdown messages-dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope"></i> Сообщения <span class="badge">2</span> <b class="caret"></b></a>
